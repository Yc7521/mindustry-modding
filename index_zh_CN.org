...
#+TEXINFO_HEADER: Modding documentation for Mindustry v100 (144)
...
**** 地热发电机
    继承 [[发电机][发电机]] -- 用热 [[属性][属性]] 的地板发电. 输出公式是 ~powerProduction * heat~, 和 ~heat~ 必须大于 ~0.01~.英文：ThermalGenerator
...
** 子弹类
   ...
   * 其他特殊的子弹类.
   ...
   | fragBullet         | [[子弹类][子弹类]]   |    null | The frag bullet that will be created, may be a string, an object or null. If field is null, no frag bullet is created. |
